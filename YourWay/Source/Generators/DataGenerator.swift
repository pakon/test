...
class DataGenerator {
    ...
    fileprivate func generateData() {
        ...
        let opportunity1 = Opportunity(title: "Прыжок с парашютом",
                                       backgroundURL: "https://s3.amazonaws.com/uploads.hipchat.com/82114/593083/Xv7SzXnMMLNvrFU/plane1.png",
        ...
        let opportunity2 = Opportunity(title: "Красавица и чудовище",
                                       backgroundURL: "https://s3.amazonaws.com/uploads.hipchat.com/82114/593083/CTiWa6XtgERRoUj/cinema1.png",
        ...
        let opportunity3 = Opportunity(title: "Время для шопинга",
                                       backgroundURL: "https://s3.amazonaws.com/uploads.hipchat.com/82114/593083/RVmWGVbLA3MgQgq/shop1.png",
        ...
        let opportunity4 = Opportunity(title: "Ремонт в своей квартире",
                                       backgroundURL: "https://s3.amazonaws.com/uploads.hipchat.com/82114/593083/ljVSIQ3hTgsYpa0/repair1.png",
        ...
        step2.opportunities.append(objectsIn: [opportunity4, opportunity1, opportunity2])
        step3.opportunities.append(objectsIn: [opportunity3, opportunity4, opportunity1])
